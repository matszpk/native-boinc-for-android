...
extern const int signal_type_cnt = 8;
const char * signal_name[signal_type_cnt] =  {"spike", "gaussian", "pulse", "triplet", "spike_small", "gaussian_small", "pulse_small", "triplet_small"};
...
int signal_to_type(spike_small s)     {return(spike_t);}
int signal_to_type(gaussian_small s)  {return(gaussian_t);}
int signal_to_type(pulse_small s)     {return(pulse_t);}
int signal_to_type(triplet_small s)   {return(triplet_t);}
