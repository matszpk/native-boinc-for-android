...
const char* suspend_reason_string(int reason) {
    ...
    case SUSPEND_REASON_WIFI_DISABLED: return "wifi network was disabled";
    case SUSPEND_REASON_OS: return "requested by operating system";
    case SUSPEND_REASON_DISCHARGE: return "battery discharged";
    case SUSPEND_REASON_OVERHEAT: return "battery overheated";
    }
