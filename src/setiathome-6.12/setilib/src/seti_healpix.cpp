...
//___________________________________________________________________________________
    ...
    unsigned long i;
    for(i=0; i < npix.size(); i++) qpix.push_back(npix2qpix(npix[i]));
...
//___________________________________________________________________________________
    ...
    unsigned long i;
    for(i=0; i < npix.size(); i++) fpix.push_back(npix2fpix(npix[i]));
...
//___________________________________________________________________________________
    ...
    for(i=0; i<8; i++) my_neighbors[i] = n[i];
}
...
//___________________________________________________________________________________
    ...
    for(qpix_i = qpixlist.begin(); qpix_i != qpixlist.end(); qpix_i++) {
        if (hotpix.fetch(*qpix_i)) {
            if(hotpix.last_hit_time == 1) continue;   // no change if already high priority
...
//___________________________________________________________________________________
    ...
    for(i=0; i < disc.size(); i++) {
        ...
        if (retval) {
            while ((retval = my_star.get_next())) stars.push_back(my_star);
