...
int main(int argc, char ** argv) {
    ...
    while (keepgoing) {
      if (strcmp(type,"triplet") == 0) { retval = get_and_print (trip, minid, maxid); }
      else if (strcmp(type,"gaussian") == 0) { retval = get_and_print (gauss, minid, maxid); }
      else if (strcmp(type,"pulse") == 0) { retval = get_and_print (pul, minid, maxid); }
      else if (strcmp(type,"spike") == 0) { retval = get_and_print (sp, minid, maxid); }
      else {
