			...
			if (localName.equalsIgnoreCase("project")) {
				...
				if (localName.equalsIgnoreCase("name")) {
					...
					if (localName.equalsIgnoreCase("file")) {
						...
						String cpuString = mCurrentElement.toString();
						if (cpuString.equals("ARMv6")) {
							mPlatform.cpuType = CpuType.ARMV6;
						} else if (cpuString.equals("ARMv6 VFP")) {
							mPlatform.cpuType = CpuType.ARMV6_VFP;
						} else if (cpuString.equals("ARMv6 NEON")) {
							mPlatform.cpuType = CpuType.ARMV7_NEON;
						}  else {
							new SAXException("Invalid Cpu type");
						}
					}
				}
			}
