...
#define COMPILER_STRING "arm-linux-androideabi-g++ (GCC) 4.7.2"
...
/* Use ARM optimizations */
#define HAVE_ARMOPT 1
...
/* Define to 2 if you want PFFFT library */
#define HAVE_PFFFT 1
