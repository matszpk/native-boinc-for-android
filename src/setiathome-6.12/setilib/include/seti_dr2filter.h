...
void randomize_corrected(std::vector<T> &channel,
  ...
  fp_envelope = fftwf_plan_dft_1d(fftlen_envelope, envelope_part, envelope_part, FFTW_FORWARD,
#ifdef ANDROID
                                  FFTW_ESTIMATE
#else
                                  FFTW_MEASURE
  ...
  fp_patch = fftwf_plan_dft_1d(fftlen_patch, patch, patch, FFTW_FORWARD,
#ifdef ANDROID
                               FFTW_ESTIMATE
#else
                               FFTW_MEASURE
  ...
  fp_patch_inv = fftwf_plan_dft_1d(fftlen_patch, patch, patch, FFTW_BACKWARD,
#ifdef ANDROID
                                   FFTW_ESTIMATE
#else
                                   FFTW_MEASURE
  ...
  */
  ...
  fp_noise = fftwf_plan_dft_1d(fftlen_envelope, noise, noise, FFTW_FORWARD,
#ifdef ANDROID
                               FFTW_ESTIMATE
#else
                               FFTW_MEASURE
  ...
  fp_noise_inv = fftwf_plan_dft_1d(fftlen_envelope, noise, noise, FFTW_BACKWARD,
#ifdef ANDROID
                                   FFTW_ESTIMATE
#else
                                   FFTW_MEASURE
