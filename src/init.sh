...
#export CFLAGS="--sysroot=$SYSROOT -Wall -I$BOINCROOTDIR/include"
#export CFLAGS="--sysroot=$SYSROOT -Wall -I$BOINCROOTDIR/include -O3 -mhard-float -mfpu=vfp -mfloat-abi=softfp -fomit-frame-pointer"
#export CFLAGS="--sysroot=$SYSROOT -Wall -I$BOINCROOTDIR/include -O3 -mhard-float -march=armv7-a -mfpu=neon -mtune=cortex-a9 -mfloat-abi=softfp -fomit-frame-pointer"
export CFLAGS="--sysroot=$SYSROOT -Wall -I$BOINCROOTDIR/include -O3 -fomit-frame-pointer"
#export CFLAGS="--sysroot=$SYSROOT -Wall -I$BOINCROOTDIR/include -g"

export GDB_CFLAGS="--sysroot=$SYSROOT -Wall -g -I$BOINCROOTDIR/include"
#export CXXFLAGS="--sysroot=$SYSROOT -Wall -funroll-loops -fexceptions"
#export CXXFLAGS="--sysroot=$SYSROOT -Wall -I$BOINCROOTDIR//include -O3 -mhard-float -mfpu=vfp -mfloat-abi=softfp -fexceptions -fomit-frame-pointer"
#export CXXFLAGS="--sysroot=$SYSROOT -Wall -I$BOINCROOTDIR/include -O3 -mhard-float -march=armv7-a -mfpu=neon -mtune=cortex-a9 -mfloat-abi=softfp -fexceptions -fomit-frame-pointer"
export CXXFLAGS="--sysroot=$SYSROOT -Wall -funroll-loops -fexceptions -O3 -fomit-frame-pointer"
#export CXXFLAGS="--sysroot=$SYSROOT -Wall -I$BOINCROOTDIR/include -g -fno-rtti -fno-exceptions"
