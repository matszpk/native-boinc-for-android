...
int PROJECT::parse(XML_PARSER& xp) {
	...
	if (xp.parse_bool("unreport", unreport)) continue;
        if (xp.parse_bool("force_work_request", force_work_request)) continue;
...
int RPC_CLIENT::project_op(PROJECT& project, const char* op) {
    ...
    if (!strcmp(op, "reset")) {
        ...
        tag = "project_report";
        project.unreport = false;
    } else if (!strcmp(op, "unreport")) {
         tag = "project_unreport";
        project.unreport = true;
    } else if (!strcmp(op, "force_work_request")) {
         tag = "force_work_request";
        project.force_work_request = true;
